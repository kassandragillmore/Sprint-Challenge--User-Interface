...
Semantic HTML is code written with meaning. It makes your website more accessible for disabled users who might be using screen writers and it makes it easier for other coders to edit or fix something in your work.
...
Because it's a distributed version control system. Basically it takes a bunch of savestates on a project, so you are not writing over or changing someone's code and possibly messing it up. You make your own state to edit things so if you break something, you can easily go back. It allows for multiple developers to code on one project and collaborate. 

5. Define mobile-first design in your own words.

It's designing web pages to be as usable on mobile as they are on a conputer because most people look at webpages on their phone and there are things, such as the horizontal scroll bar of doom, that are hard to use on a mobile. 
